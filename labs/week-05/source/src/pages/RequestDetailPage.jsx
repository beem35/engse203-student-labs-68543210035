...
function RequestDetailPage() {
  ...
  return (
    <section data-testid="page-request-detail">
      <div className="page-heading"><div><p className="eyebrow dark">ROUTED · DYNAMIC DETAIL</p><h1>รายละเอียดคำร้อง</h1><p>อ่านรหัสจาก URL: <code>{requestId}</code></p></div></div>
