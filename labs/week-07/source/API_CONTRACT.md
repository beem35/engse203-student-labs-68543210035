...
| **Base URL (ใช้งานจริง)** | `http://localhost:5173/#/`              |
| **รูปแบบข้อมูล**          | JSON (`Content-Type: application/json`) |
| **การยืนยันตัวตน**        | ยังไม่มีในเวอร์ชันนี้                   |
| **ผู้จัดทำ**              | `ปัณณวัฒน์ สิทธิตัน 68543210035-0`      |
| **วันที่ปรับปรุงล่าสุด**  | `15/09/2026`                            |

---

## 2. ภาพรวมระบบ

ระบบรับคำรองขอใช้บริการภายในมหาวิทยาลัย สำหรับให้นักศักษาและบุคลากรแจ้งปัญหาหรือขอใช้อุปกรณ์ผ่านเว็บได้ เจ้าหน้าที่จะดูรายการคำร้องและปรับสถานะการดำเนินงาน ปิดงานเมื่อเสร็จสิ้น

โดยเก็บข้อมูลผ่าน API ที่เป็นส่วนหลังบ้านให้บริการข้อมูลแก่เว็บแอปพลิเคชัน และแยกจากส่วนแสดงผลอย่างสมบูรณ์
...
| 7 | `POST` | `/api/requests/reset` | คืนค่าคำร้องเดิม | 200 |  — |
---
...
**ทำอะไร** `เปลี่ยนสถานะคำร้องโดยใช้ id และ status ที่ต้องการจะเปลี่ยน`
...
**ทำอะไร** `ลบคำร้องตาม id ที่กำหนด`
...
### 5.6 ✍️ `POST /api/requests/reset` — คืนค่าคำร้องกลับ

**ทำอะไร** `คืนค่าคำร้องกลับไปเหมือนเดิม`
...
| -------- | ---------- | -------------------------------------- | :-------: |
| 1.0.0    | 14/09/2026 | เวอร์ชันแรก — GET, POST, DELETE        |     —     |
| 2.0.0    | 14/09/2026 | เพิ่ม `PUT /api/requests/:id` และ CORS |    ไม่    |
| 2.1.0    | 14/09/2026 | เพิ่ม `DELETE /api/requests/:id`       |     —     |
| 2.2.0 | 15/09/2026 | เพิ่ม `POST /api/requests/reset` | — |
---
